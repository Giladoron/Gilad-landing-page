...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2 text-gray-300">
        <p>ממש לא. דיאטות כאסח נכשלות ברוב המקרים בטווח הארוך.</p>
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2 text-gray-300">
        <p>כן. אם יישמת את התוכנית ולא הגעת למה שסיכמנו – אני ממשיך ללוות אותך ללא עלות נוספת או מציע החזר כספי מלא, בהתאם לתנאי ההתחייבות כפי שהוגדרו מראש.</p>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-4 text-gray-300">
        ...
        <ul className="list-disc pr-6 space-y-2">
          <li>ניווט באמצעות המקלדת – אנו פועלים לאפשר גישה לכל הפונקציות באתר גם ללא שימוש בעכבר, בהתאם להנחיות WCAG.</li>
          <li>היררכיית כותרות ברורה ותקינה – מבנה לוגי של התוכן</li>
          <li>טקסטים חלופיים (Alt-text) לתמונות משמעותיות – תמיכה בקוראי מסך</li>
          <li>ניגודיות צבעים ומצבי מיקוד נראים – האתר תוכנן כך שברוב חלקיו יעמוד בדרישות הניגודיות והפוקוס של תקן WCAG AA.</li>
          ...
          <li>ייתכן שחלקים מסוימים באתר טרם הונגשו באופן מלא, או שקיימות מגבלות נגישות נקודתיות. אם נתקלתם בקושי כלשהו, נשמח שתפנו אלינו ונעשה מאמץ סביר לטפל בכך בהקדם.</li>
        </ul>
  ...
  privacy: {
    ...
    content: (
      <div className="space-y-4 text-gray-300">
        ...
        <p>מדיניות זו חלה על האתר והשירותים המופעלים על ידי גילעד דורון. הפרטיות שלך חשובה לנו מאוד. מדיניות פרטיות זו מסבירה איזה מידע אנו אוספים, כיצד אנו משתמשים בו, עם מי אנו חולקים אותו, ומה הן הזכויות שלך ביחס למידע זה.</p>
  ...
  terms: {
    ...
    content: (
      <div className="space-y-4 text-gray-300">
        ...
        <p>מובהר כי כל התחייבות להחזר כספי או להמשך ליווי מותנית בעמידה מלאה של הלקוח בתנאי התוכנית, כפי שסוכמו מראש, ואינה מהווה התחייבות לתוצאה רפואית או פיזית ספציפית.</p>
        ...
        <p><strong>החזר כספי:</strong> לפי מדיניות העסק, אם יישמת את התוכנית במלואה ולא הגעת למטרות שנקבעו, אתה זכאי להמשך ליווי בחינם לפרק זמן סביר ומוגדר מראש, בהתאם למטרות ולתוכנית שנקבעו בין הצדדים, או להחזר כספי מלא, לפי בחירתך. החזר כספי יחושב על בסיס הזמן שנותר מתקופת הליווי. לעניין סעיף זה, &quot;יישום מלא של התוכנית&quot; משמעו עמידה בהנחיות המרכזיות שנקבעו, לרבות ביצוע אימונים, דיווחים, ומעקב בהתאם למה שסוכם במסגרת הליווי.</p>
